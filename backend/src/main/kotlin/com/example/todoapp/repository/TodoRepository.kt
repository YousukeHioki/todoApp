...
interface TodoRepository {
    ...
    fun updateTodoItem(PK: String, todo: TodoRequest): String?
...
//    val newPK = UUID.randomUUID().toString()
    ...
    override fun updateTodoItem(PK: String, todo: TodoRequest): String {
        //追加したいアイテム
        val item = mapOf(
            //ランダムなUUIDをPKに入れる
            "PK" to fromS(PK),
...
//    @PutMapping("/todo/{PK}")
//    fun updateTodoItem(@PathVariable PK: String, @RequestBody todo: TodoRequest): String {
